      ...
      <div className="w-full bg-[#F6F1FF] pt-20 pb-12 mt-12 ">
        <ContainerLayout>
          <div className="w-full request-bg min-h-[300px] px-4 lg:min-h-[500px] flex flex-col items-center justify-center">
            <h1 className="text-customBlack text-center text-2xl lg:text-[36px] font-semibold ">
              REQUEST A DEMO
            </h1>
            <p className="text-ash text-base lg:text-xl text-center max-w-[738px] mx-auto font-medium mt-2">
              Our team will set up a meeting with you to discuss how you can
              gather smarter insight with WeCollect
            </p>
            <div className=" w-full max-w-[818px] rounded-[50px] h-[46px] lg:h-[75px] bg-white bg-opacity-60 flex justify-between px-4 items-center mt-8">
              <input
                type="text"
