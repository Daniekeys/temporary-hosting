      ...
      <ContainerLayout>
        <div className="w-full mt-8 lg:min-h-[271px] bg-white flex items-center lg:px-[100px] lg:py-[50px] rounded-[30px]">
          <div className="w-full grid grid-cols-1 lg:grid-cols-3">
            ...
            {/* start */}
            <div
              className="w-full flex flex-col justify-center items-center gap-4 border-t-[10px] border-b-[10px]  border-l-[#F9F6FF] border-t-[#F9F6FF] lg:border-l-[10px] lg:border-r-[10px] border-b-[#E2D6FF] border-r-[#F9F6FF] lg:border-t-0 lg:border-b-0 "
              data-aos="fade-up"
              data-aos-delay="600"
              data-aos-duration="1000"
            >
